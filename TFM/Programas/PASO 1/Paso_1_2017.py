...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 11:33:20 2021
...
ruta_zip = glob.glob('/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/RV17*.zip')
#print(ruta_zip)

ruta = glob.glob('/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/RV17*.zip')
...
for i in range(len(ruta_zip)):
    ...
    os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal")         
    ...
    archivo_zip.extractall(pwd=None, path="/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal")
    
    today_zip = zipfile.ZipFile( '/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal/today_rv.zip' , "r")
    today_zip.extractall(pwd=None, path="/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal")
    
    
    #leemos la tabla que nos interesa:
    tabla_precio = pd.read_table( '/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal/CCONTRSTAT.c2', sep=";",header=None, names=None , index_col=None  ) 
    ...
    tabla_otra = pd.read_table( '/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal/CCONTRACTS.C2', sep=";" ,header=None, names=None , index_col=None ) 
    ...
    shutil.rmtree("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/temporal")
  

#mover os csv a una carpeta:
os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_CALLS")     
os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_PUTS")      
csv_C = glob.glob("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/C*.csv")
csv_P = glob.glob("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/P*.csv")

for i in range(len(csv_P)):  
    shutil.move( csv_C[i] , "/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_CALLS")   
    shutil.move( csv_P[i] , "/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_PUTS")              
