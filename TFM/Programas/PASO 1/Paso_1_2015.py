...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 28 22:59:52 2021
...
ruta_zip = glob.glob('/Users/usuario/Documents/MASTER/Datos_TFM/2015/RV*.zip')
print(ruta_zip)

ruta = glob.glob('/Users/usuario/Documents/MASTER/Datos_TFM/2015/RV*.zip')
...
for i in range(len(ruta_zip)):
    ...
    os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal")         
    ...
    archivo_zip.extractall(pwd=None, path="/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal")
    
    today_zip = zipfile.ZipFile( '/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal/today_rv.zip' , "r")
    today_zip.extractall(pwd=None, path="/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal")
    
    
    #leemos la tabla que nos interesa:
    tabla_precio = pd.read_table( '/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal/CCONTRSTAT.c2', sep=";",header=None, names=None , index_col=None  ) 
    ...
    tabla_otra = pd.read_table( '/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal/CCONTRACTS.C2', sep=";" ,header=None, names=None , index_col=None ) 
   ...
   # df_ibex_put.to_csv('P' + nombres[i] + ".csv")
    ...
    shutil.rmtree("/Users/usuario/Documents/MASTER/Datos_TFM/2015/temporal")
  
'''   
    
#mover os csv a una carpeta:
os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2015/2015_CALLS")     
os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2015/2015_PUTS")      
csv_C = glob.glob("/Users/usuario/Documents/MASTER/Datos_TFM/2015/C*.csv")
csv_P = glob.glob("/Users/usuario/Documents/MASTER/Datos_TFM/2015/P*.csv")

for i in range(len(csv_P)):  
    shutil.move( csv_C[i] , "/Users/usuario/Documents/MASTER/Datos_TFM/2015/2015_CALLS")   
    shutil.move( csv_P[i] , "/Users/usuario/Documents/MASTER/Datos_TFM/2015/2015_PUTS")              
