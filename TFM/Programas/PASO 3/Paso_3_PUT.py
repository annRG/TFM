...
csv = glob.glob("P17*_SEMIFINAL.csv")
...
for j in range(len(csv)): 
    ...
    for i in range(n):
        ...
        obj_mibian = mibian.BS(data_mibian_bs, putPrice=callPrice)
...
os.makedirs("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_PUTS/2017_SEMIFINAL_PUTS/2017_FINAL_PUTS")     
csv_C = glob.glob("/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_PUTS/2017_SEMIFINAL_PUTS/P*_FINAL.csv")

for i in range(len(csv_C)):  
    shutil.move( csv_C[i] , "/Users/usuario/Documents/MASTER/Datos_TFM/2017/RV/2017_PUTS/2017_SEMIFINAL_PUTS/2017_FINAL_PUTS")  
